 ...
 * Version: V1.10 	2023 : MODIF JLN : ajustements timings
 * compiler avec optimisation ZERO sinon la fonction delay() est RUINEE
 *----------------------------------------------------------------------------
...
{
  LCD_RW(0)
  delay(5);	// JLN added : RW setup
  LCD_E(1)
  LCD_DATA_OUT(c&0x0F)
  delay(10);
  LCD_E(0)
  delay(5);	// JLN reduced : data & ctrl hold
}
